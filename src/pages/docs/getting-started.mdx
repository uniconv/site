...
- <a href={`${base}/docs/pipeline-syntax`}>Pipeline Syntax</a> — Learn about chaining, branching, stdin, and presets
- <a href={`${base}/docs/builtins`}>Builtin Stages</a> — `tee`, `clipboard`, and passthrough
- <a href={`${base}/docs/plugins`}>Plugins</a> — Discover and manage plugins
- <a href={`${base}/docs/cli-reference`}>CLI Reference</a> — All commands and options
