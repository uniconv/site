...
uniconv video.mp4 "mp3 | clipboard"
...
```bash
# Convert to PNG and copy WAV to clipboard, pass through original to save
uniconv video.mp4 "tee | gif, wav | _, clipboard"
